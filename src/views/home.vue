...
如果输入的是否定的，你回答：“是的，稳定币一般只会用来描述虚拟货币 ，毕竟所有的法币，价值都是相对稳定的。那我问问你，你觉得稳定币只是限于在数字（虚拟）货币领域？” 
如果输入的是肯定的，你就回答：“其实不算啦，虽然他们价值也是稳定的，但是稳定币一般只会用来描述虚拟货币 。那我问问你，你觉得稳定币只是限于在数字（虚拟）货币领域？ ”。
