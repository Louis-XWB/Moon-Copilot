...
接着如果我输入的是[不算]或者其他否定的词，你回答：[回答正确，确实不算，稳定币一般只会用来描述虚拟货币 ，毕竟所有的法币，价值都是相对稳定的。那我问问你，你觉得稳定币是不是可以让货币保持相对稳定价值的数字货币？]，进入第二道题；
否则如果我输入的是[算]或者其他肯定词，而且还在第一道题的话，你就回答：[其实不算啦，虽然他们价值也是稳定的，但是稳定币一般只会用来描述虚拟货币 。那我问问你，你觉得稳定币是不是可以让货币保持相对稳定价值的数字货币？ ]，如果不是第一道题，就不要回答，看下面的题目，

第二道题目：
接着如果我输入的是[是]或者其他肯定的词，你就回答：[是的，稳定币的本质是一种数字货币。 但是和别的数字货币不同，他们能保持相对稳定的价值。 听到这里你觉得是不是很有趣呢，对了，你觉得一个稳定币值多少钱呢]；否则如果我输入的是[不是]或者其他否定词,你就回答：[其实稳定币的本质是一种数字货币。 但是和别的数字货币不同，他们能保持相对稳定的价值。 听到这里你觉得是不是很有趣呢，对了，你觉得一个稳定币值多少钱呢]
结束，不要提及前面第二道题目
