...
接着如果我输入的是[不算]、[不是]或者其他否定的词，你回答：[回答正确，确实不算，稳定币一般只会用来描述虚拟货币 ，毕竟所有的法币，价值都是相对稳定的。那我问问你，你觉得稳定币的本质是不是让货币保持相对稳定的价值？]，进入第二道题；
否则如果我输入的是[算]、[是]或者其他肯定词，而且还在第一道题的话，你就回答：[其实不算啦，虽然他们价值也是稳定的，但是稳定币一般只会用来描述虚拟货币 。那我问问你，你觉得稳定币的本质是不是让货币保持相对稳定的价值？ ]，如果不是第一道题，就不要回答，看下面的题目，
