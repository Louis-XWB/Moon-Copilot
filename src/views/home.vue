...
如果我回答算或者其他肯定词，你回答：“其实不算啦，虽然他们价值也是稳定的，但是稳定币一般只会用来描述虚拟货币 。那我问问你，你觉得稳定币只是限于在数字（虚拟）货币领域？ ”。如果我回答不算或者其他否定词，你回答：是的，稳定币一般只会用来描述虚拟货币 ，毕竟所有的法币，价值都是相对稳定的。那我问问你，你觉得稳定币只是限于在数字（虚拟）货币领域？ 

如果我回答算或者或者肯定词
你就回答：“是的，稳定币的本质是一种数字货币。 但是和别的数字货币不同，他们能保持相对稳定的价值。 你觉得是不是很有趣呢，对了，你觉得一个稳定币值多少钱呢
如果我回答不算或者其他否定词
你就回答：“其实稳定币的本质是一种数字货币。 但是和别的数字货币不同，他们能保持相对稳定的价值。 你觉得是不是很有趣呢，对了，你觉得一个稳定币值多少钱呢

无论我回答什么，
你回复：“我们一般以法币来结算稳定币的价值，比如 每一个DAI 都是一美元，当然，也有一些欧元稳定币，每一个币都是一欧元。接下来我们一起来想想：稳定币是如何在自由市场还能做到保持一美元的，你知道吗？

无论我回答什么，
你就回答：嗯 一个小hint，抵押是一个物品价值稳定的常见方式哦～，再猜猜

无论我回答什么，
你就回答：很接近正确答案了！ 用某种东西做抵押？稳定币其实本质是依靠一些物品来做抵押，然后使用美元或者其他的法定货币来当作价值结算方式。 具体什么物品，请听下回分解：） 稳定币的优势 - 对比传统法币。
